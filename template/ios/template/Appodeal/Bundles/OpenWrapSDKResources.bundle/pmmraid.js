...
(function() {
 ...
 /**
 * Custom implementation to check app install status
 * @since OpenWrap SDK v4.10.0
 * @param {*} app The deeplink url of the app to check for installation
 */
 mraidService.requestAppInstallStatus = function(app) {
 // Store request for response correlation
 mraidService._appInstallRequests = app;
 // Create a timeout, if the response is not received within 2 seconds, fire an event with appInstallStatus = -1
 ...
 * @since OpenWrap SDK v4.10.0
 * @param {*} app The deeplink url of the app to check for installation
 * @param {*} appInstallStatus 1 if the app is installed, 0 if the app is not installed,
 ...
 */
 ...
 if ( mraidService._appInstallRequests && mraidService._appInstallRequests === app ) {
 mraidService._appInstallRequests = null;
 ...
 * Creative can use this feature to show a specific CTA button like "Add To Cart" or "Book now" etc.
 * based on the app install status.
 ...
 * mraid.appInstallStatus("owsdktoolapp://");
 *
 * @since OpenWrap SDK v4.10.0
 * @param {*} app The deeplink url of the app to check for installation
 */
 requestAppInstallStatus: function(app) {
 return mraidService.requestAppInstallStatus(app);
 }
 };
